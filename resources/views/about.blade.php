    ...
    <div class="section">
        <div class="row vertical-align">
            <div class="col-sm-6 col-sm-offset-2">
                <h4>So who is Kevin Skompinski?</h4>
                Kevin Skompinski is an entrepenuer and software developer who graduated from the University at Buffalo in 2013, and is the founder of Discreet Drop. I've had the idea for discreet Drop for a few years now, and after watching Casey Neistat's work-ethic in building his business, decided to finally craft my own startup from scratch with as much care and attention to detail as possible. I now serve as CEO, sole developer, and package processor.<br><br>
            ...
            <div class="col-sm-2">
                <img src="http://placeholder.pics/svg/400x400" class="img-responsive center-block svg img-circle" alt="Responsive image">
            </div>
        </div>
    </div>
</div>
