...
@section('description', 'Hide logos, return labels, invoices, holes, and all other identifying information on any package, from any seller, so your items arrive as discreet as possible.')
