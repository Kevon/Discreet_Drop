...
<div class="container content page">
    ...
    <div class="row">
        <h2 class="col-sm-12 center">Why You Need Discreet Shipping</h2>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Logos on Packaging</div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Return Labels</div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Packing slips</div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Damaged Packages/Holes</div>
            </div>
        </div>
    </div>
    
    <div class="row">
        <h2 class="col-sm-12 center">Discreet Drop hides all logos and return addresses</h2>
        <h4 class="col-sm-12 center">Only you would know what's in your private shipments</h4>
        <div class="col-sm-12">
    ...
    <div class="row">
        <h2 class="col-sm-12 center">Discreet Drop Benefits and Uses</h2>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Keeps personal items a secret</div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Gifts for other members of your home</div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Deter theives from flashy labels</div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="panel panel-default center">
            <div class="panel-body">Ship to PO boxes</div>
            </div>
        </div>
    </div>
